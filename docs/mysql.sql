...
-- ----------------------------
BEGIN;
INSERT INTO `t_admin` VALUES (1, 'admin', 'I73HdMcNGgbtpprvPl0W8eDosoiXs9u9W84SbIz3dgGjjIWb64Lu2', '管理员', '596392912@qq.com', '15321111111', 0, 0, 0, 1, 0, 1, '2018-01-30 10:08:41', '2018-04-16 14:59:38');
INSERT INTO `t_admin` VALUES (2, 'test', 'I73HdMcNGgbtpprvPl0W8eDosoiXs9u9W84SbIz3dgGjjIWb64Lu2', '测试', '596392912@qq.com', NULL, 0, 0, 1, 6, 0, 1, '2018-03-28 04:26:31', '2018-04-14 23:21:52');
COMMIT;
...
CREATE TABLE `t_camera_brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='码流配置';

-- ----------------------------
-- Records of t_camera_brand
-- ----------------------------
INSERT INTO `t_camera_brand` VALUES ('1', '大华', 'rtsp://%s:%s@%s:554/cam/realmonitor?channel=1&subtype=0', 'rtsp://%s:%s@%s:554/cam/realmonitor?channel=1&subtype=1', '1', '1', 'admin', '2019-08-13 14:20:00', 'admin', '2019-08-13 15:17:35');
INSERT INTO `t_camera_brand` VALUES ('2', '海康', 'rtsp://%s:%s@%s:554/h264/ch1/main/av_stream', 'rtsp://%s:%s@%s:554/h264/ch1/sub/av_stream', '1', '2', 'admin', '2019-08-13 14:20:00', null, '2019-08-13 14:40:45');
INSERT INTO `t_camera_brand` VALUES ('3', '宇视', 'rtsp://%s:%s@%s:554/video1', 'rtsp://%s:%s@%s:554/video2', '1', '3', 'admin', '2019-08-13 14:20:00', null, '2019-08-13 14:40:47');
INSERT INTO `t_camera_brand` VALUES ('4', '华为', 'rtsp://%s:%s@%s:554/LiveMedia/ch1/Media1', 'rtsp://%s:%s@%s:554/LiveMedia/ch1/Media2', '1', '4', 'admin', '2019-08-13 14:20:00', null, '2019-08-13 14:40:49');
...
CREATE TABLE `t_camera` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态[0:失效,1:正常]',
  `heart_time` datetime COMMENT '最后心跳',
  `seq` tinyint(2) NOT NULL DEFAULT '0' COMMENT '排序',
  `create_by` varchar(10) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT '1970-01-01 00:00:00' COMMENT '创建时间',
  `update_by` varchar(10) DEFAULT NULL COMMENT '修改人',
  `update_time` datetime DEFAULT '1970-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='摄像机配置';
...
CREATE TABLE `t_net_card` (
  ...
  `dns` varchar(150) COMMENT '首选DNS',
  `dns2` varchar(150) COMMENT '备用DNS',
  `gateway` varchar(150) COMMENT '默认网关',
  `ipv4` varchar(100)  COMMENT 'IPV4地址',
  `isAuto` tinyint(1) COMMENT '开机自启动',
  `mac` varchar(100) COMMENT 'mac地址',
  `mask` varchar(100) COMMENT '子网掩码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='网卡信息';
